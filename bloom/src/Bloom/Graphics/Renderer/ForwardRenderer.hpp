...
namespace bloom {
	...
	namespace {
		...
		struct FWRenderData {
			...
			BufferHandle rendererParameters;
			BufferHandle debugDrawDataBuffer;
	...
	public:
		...
		void submit(Reference<StaticMeshRenderer>, Reference<Material>, mtl::float4x4 const& transform) override;
