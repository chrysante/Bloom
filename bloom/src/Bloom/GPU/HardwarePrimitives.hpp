...
#include "HardwareResourceHandle.hpp"
...
namespace bloom {
	...
	public:
		...
		BufferHandle(void* native, Deleter deleter, BufferDescription desc): HardwareResourceHandle(native, deleter), desc(desc) {}
	...
	public:
		...
		BufferView(BufferHandle const& buffer): HardwareResourceView(buffer), desc(buffer.desc) {}
	...
	public:
		...
		TextureView(void* native, TextureDescription desc):
			HardwareResourceView(native),
			desc(desc)
		{}
		TextureView(TextureHandle const& texture):
			HardwareResourceView(texture),
	...
	public:
		...
		ShaderFunctionHandle(void* native, Deleter deleter): HardwareResourceHandle(native, deleter) {}
	};
	...
	public:
		...
		RenderPipelineHandle(void* native, Deleter deleter): HardwareResourceHandle(native, deleter) {}
	};
	...
	class BLOOM_API ComputePipelineHandle:
		public HardwareResourceHandle, public ComputePipelineParameters
	{
	public:
	...
	public:
		...
		ComputePipelineView(ComputePipelineHandle const& pipeline):
			HardwareResourceView(pipeline),
			ComputePipelineParameters(pipeline)
		{}
	};
	...
	public:
		...
		DepthStencilHandle(void* native, Deleter deleter): HardwareResourceHandle(native, deleter) {}
	};
	...
	public:
		...
		SamplerHandle(void* native, Deleter deleter): HardwareResourceHandle(native, deleter) {}
	};
