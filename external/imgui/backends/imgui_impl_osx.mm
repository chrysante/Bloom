...
static ImKeyEventResponder*   g_KeyEventResponder = nil;
 ...
 */
@interface ImKeyEventResponder: NSView<NSTextInputClient>
@end

@implementation ImKeyEventResponder
{
    float _posX;
    float _posY;
    NSRect _imeRect;
