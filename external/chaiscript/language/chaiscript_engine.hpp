...
namespace chaiscript {
  ...
  public:
    ...
    /// \param[in] t_module_paths Vector of paths to search when attempting to load a binary module
    /// \param[in] t_use_paths Vector of paths to search when attempting to "use" an included ChaiScript file
