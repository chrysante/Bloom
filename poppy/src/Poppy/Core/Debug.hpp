...
#define poppyAssert(...) \
	UTL_FANCY_ASSERT("Poppy", POPPY_DEBUGLEVEL, assertion, __VA_ARGS__)
#define poppyExpect(...) \
	UTL_FANCY_ASSERT("Poppy", POPPY_DEBUGLEVEL, precondition, __VA_ARGS__)
#define poppyEnsure(...) \
	UTL_FANCY_ASSERT("Poppy", POPPY_DEBUGLEVEL, postcondition, __VA_ARGS__)
#define poppyDebugbreak(msg) \
	__utl_debugbreak(msg)
#define poppyDebugfail(msg) \
	__utl_debugfail(msg)
#define poppyBoundsCheck(index, lower, upper) \
	UTL_FANCY_BOUNDS_CHECK("Poppy", POPPY_DEBUGLEVEL, index, lower, upper)
