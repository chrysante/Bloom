...
namespace bloom {
	...
	public:
		...
		void setVertexBuffer(BufferView, std::size_t index, std::size_t offset) override;
		...
		void setFragmentBuffer(BufferView, std::size_t index, std::size_t offset) override;
		void setFragmentBufferOffset(std::size_t index, std::size_t offset) override;
