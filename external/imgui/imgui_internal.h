...
enum ImGuiTabItemFlagsPrivate_
{
	...
	ImGuiTabItemFlags_DockSpaceTab              = 1 << 24   // [Docking] Tab is dockspace tab
};
...
//#endif
    ...
    IMGUI_API bool          BeginMenuEx(const char* label, const char* icon, bool enabled = true, bool* out_pressed = nullptr);
