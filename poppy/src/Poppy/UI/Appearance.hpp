...
BLOOM_MAKE_TEXT_SERIALIZER(poppy::StyleVars, windowBorder, childWindowBorder,
                           popupBorder, frameBorder, tabBorder, windowRounding,
                           childWindowRounding, popupRounding, frameRounding,
                           tabRounding, selectableRounding, grabMinSize,
                           grabRounding, scrollbarSize, scrollbarRounding,
                           windowTitleAlign);

BLOOM_MAKE_TEXT_SERIALIZER(poppy::StyleColorDescription, controlFrame,
                           controlFrameHovered, controlFrameDown,
                           highlightControlFrame, highlightControlFrameHovered,
                           highlightControlFrameDown, checkMark, tab, tabActive,
                           tabUnfocused, tabUnfocusedActive, text, textDisabled,
                           windowBG, popupBG, menubarBG, border, windowTitleBar,
                           activeWindowTitleBar, separator, scrollbar,
                           dockPreview);
